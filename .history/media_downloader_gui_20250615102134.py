...
class MediaSlayerGUI:
    ...
    def create_ui(self):
        ...
        # Simular gradiente de fundo - Ajustado para novo tamanho
        gradient_canvas = self.create_gradient_frame(main_frame, '#0f172a', '#1e293b', 750, 650)
        ...
        self.download_btn.pack(fill=tk.X, pady=(18, 0), ipady=6)  # Reduzido pady de 25 para 18 e ipady de 8 para 6
